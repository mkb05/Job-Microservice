...
public class ReviewController {
	...
	public ResponseEntity<String> updateReview(@PathVariable Long companyId,
		...
		if(isReviewUpdated)
			return new ResponseEntity<>("Reivew upadated successfully",
				HttpStatus.OK);
		else
			return new ResponseEntity<>("Reivew not upadated ",
					HttpStatus.NOT_FOUND);
	}
	...
	public ResponseEntity<String> deleteReview(@PathVariable Long companyId,
		...
		if(isReviewDeleted)
			return new ResponseEntity<>("Reivew deleted successfully",
				HttpStatus.OK);
		else
			return new ResponseEntity<>("Reivew not deleted ",
					HttpStatus.NOT_FOUND);
	}
}
